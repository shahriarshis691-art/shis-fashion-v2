...
export const shopCategories: ShopCategory[] = [
  ...
  { slug: 'western-outfits', title: 'Western Outfits', description: 'Modern staples with a bold edge — crop tops, shirts, denim shorts, trousers, and skirts.', image: '/western/western-1.webp' },
