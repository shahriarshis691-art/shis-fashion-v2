...
export const WOMENS_BAGGY_HERO_IMAGE = '/hero/womens-baggy/womens-jeans-listing.webp'
export const WOMENS_BAGGY_HERO_IMAGE_FALLBACK = '/hero/womens-baggy/womens-jeans-listing.webp'
export const WOMENS_BAGGY_HERO_WIDTH = 1600
export const WOMENS_BAGGY_HERO_HEIGHT = 1067
