...
const defaultProducts: AdminProduct[] = [
  ...
  },
  {
    ...
    name: 'Unisex Oversize Tee',
    price: '৳ 699',
    stock: 123,
    sizes: ['M', 'L', 'XL', 'XXL'],
    colors: ['Black', 'Stone'],
    description: 'Unisex Oversize Tee — relaxed, premium cotton for everyday wear. Sold: 49 pcs. Available for quick nationwide dispatch.',
    category: 'unisex-tee',
    images: [
      '/assets/products/unisex-oversize-1.jpg',
      '/assets/products/unisex-oversize-2.jpg',
    ],
  ...
  {
    id: 'seed-kids-playset-1',
    name: 'Kids Playset Classic',
    price: '৳ 1,199',
    stock: 38,
    sizes: ['XS', 'S', 'M'],
    colors: ['Sky', 'White'],
    description: 'Breathable everyday set for active kids with soft comfort fabric.',
    category: 'kids',
    images: [
      'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?auto=format&fit=crop&w=1400&q=80',
      'https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=1400&q=80',
    ],
    imageTitles: ['Front look', 'Lifestyle look'],
    imageDescriptions: ['Primary product image for kids playset classic.', 'Lifestyle image for fit and comfort view.'],
    videos: [],
    featured: false,
    newArrival: true,
    hero: false,
  ...
  {
    id: 'seed-kids-denim-day',
    name: 'Kids Denim Day',
    price: '৳ 1,499',
    stock: 27,
    sizes: ['S', 'M', 'L'],
    colors: ['Denim Blue'],
    description: 'Durable denim-inspired look designed for all-day movement.',
    category: 'kids',
    images: [
      'https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?auto=format&fit=crop&w=1400&q=80',
      'https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1400&q=80',
    ],
    imageTitles: ['Front look', 'Detail look'],
    imageDescriptions: ['Primary product image for kids denim day.', 'Secondary detail image for texture and stitching.'],
    videos: [],
    featured: false,
    newArrival: false,
    hero: false,
  ...
  {
    id: 'seed-kids-soft-knit',
    name: 'Kids Soft Knit Set',
    price: '৳ 1,299',
    stock: 31,
    sizes: ['XS', 'S', 'M'],
    colors: ['Mint', 'Stone'],
    description: 'Soft-knit comfort set made for school, play, and weekend trips.',
    category: 'kids',
    images: [
    ...
    imageTitles: ['Front look', 'Lifestyle look'],
    imageDescriptions: ['Primary product image for kids soft knit set.', 'Lifestyle image with movement and outfit context.'],
    videos: [],
    featured: true,
    newArrival: true,
    hero: false,
  ...
  {
    id: 'seed-kids-weekend-comfort',
    name: 'Kids Weekend Comfort',
    price: '৳ 1,099',
    stock: 42,
    sizes: ['S', 'M', 'L'],
    colors: ['Peach', 'Ivory'],
    description: 'Easy weekend essential with lightweight fabric and a relaxed fit.',
    category: 'kids',
    images: [
      'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80',
      'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&w=1400&q=80',
    ],
    imageTitles: ['Front look', 'Close detail'],
    imageDescriptions: ['Primary product image for kids weekend comfort.', 'Closer detail image for fabric and finish.'],
    videos: [],
    featured: false,
    newArrival: false,
    hero: false,
