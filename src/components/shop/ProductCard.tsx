...
const ProductCard = memo(function ProductCard({
  ...
  const detailHref = href ?? (/half-shirt|oversized-tee|unisex-tee|western|kurti/i.test(product.category) || product.subCategory === 'shirts' ? `/product/${product.slug}` : undefined)
