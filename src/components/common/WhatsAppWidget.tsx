...
export default function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed z-40 flex h-14 w-14 items-center justify-center rounded-full border border-black/10 bg-black text-white shadow-[0_10px_28px_rgba(0,0,0,0.22)] transition hover:bg-black/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black right-[max(1rem,env(safe-area-inset-right))] bottom-[max(1.15rem,env(safe-area-inset-bottom))] touch-manipulation"
    >
